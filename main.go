...
func init() {
	...
	url := flag.String("u", "ws://frp-act.top:19834", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "啊骏", "Set default nickname.")
	...
	// 通过代码写死的方式添加主人账号
	 sus = append(sus, 3514947495)
	sus = append(sus, 2014797073)
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "狗白", "欧子", "峰峰", ),
